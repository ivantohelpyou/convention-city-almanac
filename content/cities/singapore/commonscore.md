...
|---|---|---|---|---|---|---|
| 1 | Food | 11 | 1.0 | 0.7 | 7.7 | **Hawker centres** — 114+ centres, UNESCO Intangible Cultural Heritage (2020). Vendor participation is a national institution: affordable stall rental, daily operation, multigenerational. The highest Food score in the dataset. |
| 2 | Civic | 11 | 0.8 | 0.5 | 4.4 | **108 Community Clubs/Centres** (one per constituency). *NLB (National Library Board) — 27 libraries.* Meeting rooms bookable at community centres. Government-engineered civic infrastructure. |
| 3 | Education | 9 | 0.8 | 0.5 | 3.6 | **SkillsFuture** — government program providing $500 credit per citizen for lifelong learning. *Community centre courses.* Polytechnic continuing ed. Education participation as national policy. |
...
| 7 | Industry | 7 | 0.8 | 0.8 | 4.5 | Sands Expo (~120K sqm) + Singapore EXPO. Major global convention hub. *Sibos 2015.* MICE industry is a national priority. |
...
| 11 | Wellness | 5 | 0.7 | 0.4 | 1.4 | **ActiveSG** — government sports platform with 90+ facilities (pools, gyms, stadiums). *Fitness corners in HDB estates (everywhere).* Community pools. |
| 12 | Seniors | 4 | 0.7 | 0.4 | 1.1 | **Senior Activity Centres (SACs)** across HDB estates. *Silver Generation programmes.* Aging population drives investment. |
...
| 15 | Sports | 2 | 0.7 | 0.4 | 0.6 | **ActiveSG** (90+ facilities). Community sports through CCs. *Dragon boat, running clubs.* Government-structured participation. |
...
*[CommonScore methodology](/commonscore/) | [Singapore overview](/cities/singapore/)*
