...
- **[Finance](/cities/seattle/finance/)** — Bond schedule, lodging tax, operating performance, reserves, debt service cliff
- **[Construction](/cities/seattle/construction/)** — Summit construction economics: $960M Clark/Lewis contract, 6,000 workers, $267M tax capture, IMPLAN methodology
- **[Labor](/cities/seattle/labor/)** — Nine unions, Aramark contract, rate card transparency, operations workforce
- **[Governance](/cities/seattle/governance/)** — PFD structure, board composition, state backstop, Aramark contract, Visit Seattle contract
- **[Corridor](/cities/seattle/corridor/)** — Pike/Pine walking tour, 920 Olive Way, Washington 1000, neighborhood transformation
- **[Players](/cities/seattle/players/)** — SCC leadership, PFD board, Visit Seattle, DSA, bond underwriters
- **[Timeline](/cities/seattle/timeline/)** — 1981 site selection through 2030 balloon, every dated event from primary sources

## Primary Sources

This almanac draws on public records including:
- **Audited financial statements** — Moss Adams LLP, published at [seattlecc.com/governance/financial-reports/](https://seattlecc.com/governance/financial-reports/)
- **Bond official statements** — 2018 issuance ($1.0B) and 2021 refunding ($544M), from [EMMA](https://emma.msrb.org/)
...
- **Walking tour observations** — 33 stops, dated photography, at [commons.conventioncityseattle.com/pike-pine](https://commons.conventioncityseattle.com/pike-pine)
...
| 12 | Seniors | 4 | 0.5 | 0.3 | 0.6 | Senior centers (*Phinney, Greenwood, others*). Horizon House. Library programming. Participation exists city-wide but at community-center scale — no convention-center-scale senior programming exists. |
